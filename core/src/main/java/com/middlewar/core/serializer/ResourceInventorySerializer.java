 ...
 */
public class ResourceInventorySerializer extends JsonSerializer<ResourceInventory> {
    @Override
    public void serialize(ResourceInventory value, JsonGenerator gen, SerializerProvider serializers) throws IOException, JsonProcessingException {
